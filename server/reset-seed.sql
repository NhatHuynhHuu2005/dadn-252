...
-- 2. Seed lại Users (3 vai trò: Admin, Manager A, Manager B, Farmer C, D, E, F, và tài khoản SYSTEM hệ thống)
...
-- 6. Seed Lịch hẹn tự động (Schedules)
...
-- 7. Seed Nhật ký hoạt động (Action Logs)
...
-- 8. Seed Ngưỡng cảnh báo mẫu (Threshold Rules)
...
-- 9. Seed Lịch sử cảm biến (Sensor History) cho biểu đồ Dashboard
-- dev-001: Nhiệt độ 1
